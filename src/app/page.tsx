...
export default function Home() {
  ...
  const promotionCost = getValue("promotionCost", basePromotionCost);
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 relative">
          ...
          <button
            ...
            className="flex items-center justify-center w-5 h-5 rounded-full hover:bg-slate-100 transition-colors shrink-0"
